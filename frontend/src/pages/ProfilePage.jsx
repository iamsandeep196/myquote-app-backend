...
function ProfilePage() {
  ...
  return (
    <>
    <Navbar />
    <div data-theme="forest" className="min-h-screen px-4 py-4 overflow-x-hidden">
      {/* Top Section */}
      <div className="flex items-center gap-6">
        {/* Profile Pic */}
        <div className="avatar">
          <div className="w-24 sm:w-32 rounded-full ring-primary ring-offset-base-100 ring-2 ring-offset-2">
            <img src={user?.userProfile || "https://static.vecteezy.com/system/resources/thumbnails/020/765/399/small/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg"} />
          </div>
        </div>
