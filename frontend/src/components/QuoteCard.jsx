  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="avatar">
            <div className="w-12 rounded-full">
              <img src={quote.userId.profilePic || "https://static.vecteezy.com/system/resources/thumbnails/020/765/399/small/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg"} alt="user" />
            </div>
          </div>
      ...
      <figure className="relative">
        ...
        {/* Quote Text On Image */}
        <div className="absolute inset-0 flex items-center justify-center p-6  whitespace-pre-wrap overflow-hidden">
          <p className="text-black text-sm font-bold text-center break-all">
            {quote.text}
          </p>
        </div>
      </figure>
